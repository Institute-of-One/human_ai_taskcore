...
108 dose series at the point estimate. The direction is not in
...
$d'^2$ in the median. The maximum is 12.3%, and where it
...
documents are available at https://github.com/Institute-of-One/human_ai_taskcore, released as v0.1.1
(commit `47f9631`) and archived at https://doi.org/10.5281/zenodo.22313885. That is
